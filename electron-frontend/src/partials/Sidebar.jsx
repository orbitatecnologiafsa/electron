...
import logo from "../images/Electron Logo Black Font.png";
...
function Sidebar({
  ...
  // fechar quando clica fora da tela
  useEffect(() => {
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              {/* Financeiro */}
              <SidebarLinkGroup activecondition={
                pathname === "/financeiro/contasareceber" ||
                pathname === "/financeiro/contasapagar" || 
                    ...
                    <React.Fragment>
                      <a
                        ...
                        className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${
                          pathname === "/financeiro/contasareceber" ||
                          pathname === "/financeiro/contasapagar" || 
                          pathname === "/financeiro/caixa" ? "" : "hover:text-gray-900 dark:hover:text-white"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          handleClick();
              ...
              <SidebarLinkGroup activecondition={
                ...
                pathname === "/configuracoes/estoque " ||
                pathname === "/configuracoes/nfe " ||
                pathname === "/configuracoes/produto " 
              }>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
              ...
              {/* Permissões */}
              <SidebarLinkGroup activecondition={
                pathname === "/permissoes/Cadastros" ||
                pathname === "/permissoes/Entradas" ||
                pathname === "/permissoes/Estoque2" ||
                pathname === "/permissoes/Financeiro" ||
                pathname === "/permissoes/Relatorios" ||
                pathname === "/permissoes/Saidas"
              }>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
