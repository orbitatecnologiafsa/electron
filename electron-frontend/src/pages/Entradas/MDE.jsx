          ...
          <div className="space-y-12 mt-10 ml-10">
            <div className="border-b border-gray-900/10 pb-12">
              <h2 className="text-base font-semibold leading-7 text-gray-900">
                Listagem Manifestação do Destinatárrio Eletrônica
              </h2>
                      ...
                      <div className="flex-auto w-full">
                        ...
                        <div className="flex rounded-md sm:max-w-md">
                          <Menu as="div" className="flex rounded-md">
                            ...
                            >
                              <div className="py-1">
                                {['Todos', 'Chave Acesso ', 'Série', 'Número', 'Emissão','CNPJ/CPF', 'Fornecedor', 'IE', 'Total', 'Status', 'Protocolo','Status MDe','Protoolo MDe','Usuário', 'Incompleto'].map(item => (
                                  <MenuItem key={item}>
                                    <a
                        ...
                        <tbody className="bg-white divide-y divide-gray-200 text-center">
                          {exampleData.map((data, index) => (
                            <tr key={index}>
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{data.chaveacesso}</td>
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{data.ie}</td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{data.total}</td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{data.status}</td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{data.protocolo}</td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{data.statusmde}</td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{data.protocolomde}</td>
