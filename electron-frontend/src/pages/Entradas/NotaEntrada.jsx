        ...
        <form>
          <div class="space-y-12 mt-10 ml-10">
            <div class="border-b border-gray-900/10 pb-12">
              <h2 class="text-base font-semibold leading-7 text-gray-900">Listagem Compras</h2>
                    ...
                    <div class="table w-full mt-5">
                      <div class="table-header-group">
                        ...
                        <div class="table-row">
                          ...
                          <div class="table-cell text-left ...">Entrada <span><FontAwesomeIcon icon={faSort}/></span></div>
                        </div>
                      </div>
                    </div>
                </div>
