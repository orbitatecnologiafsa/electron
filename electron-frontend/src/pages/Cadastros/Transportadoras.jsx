                    ...
                    <div class="table w-full mt-5">
                      <div class="table-header-group">
                        ...
                        <div class="table-row">
                          ...
                          <div class="table-cell text-left ...">Município <span><FontAwesomeIcon icon={faSort}/></span></div>
                          ...
                          <div class="table-cell text-left ...">Ult.Compra <span><FontAwesomeIcon icon={faSort}/></span></div>
                          <div class="table-cell text-left ...">Dt.Nascimento <span><FontAwesomeIcon icon={faSort}/></span></div>
                        </div>
                      </div>
                    </div>
                </div>
