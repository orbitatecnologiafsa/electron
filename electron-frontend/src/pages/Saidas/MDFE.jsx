        ...
        <form>
          <div class="space-y-12 mt-10 ml-10">
            <div class="border-b border-gray-900/10 pb-12">
              <h2 class="text-base font-semibold leading-7 text-gray-900">Listagem Manifesto de Documentos Fiscais Eletrônicos</h2>
                    ...
                    <div class="table w-full mt-5">
                      <div class="table-header-group">
                        ...
                        <div class="table-row">
                          ...
                          <div class="table-cell text-left ...">UF Carreg. <span><FontAwesomeIcon icon={faSort}/></span></div>
                          <div class="table-cell text-left ...">Placa <span><FontAwesomeIcon icon={faSort}/></span></div>
                          <div class="table-cell text-left ...">UF Descar. <span><FontAwesomeIcon icon={faSort}/></span></div>
                          <div class="table-cell text-left ...">Nº NFes <span><FontAwesomeIcon icon={faSort}/></span></div>
                          <div class="table-cell text-left ...">Carga(KG) <span><FontAwesomeIcon icon={faSort}/></span></div>
                          <div class="table-cell text-left ...">Total <span><FontAwesomeIcon icon={faSort}/></span></div>
                          <div class="table-cell text-left ...">Chave de Acesso <span><FontAwesomeIcon icon={faSort}/></span></div>
