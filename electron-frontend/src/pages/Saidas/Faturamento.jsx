        ...
        <form>
          <div class="space-y-12 mt-10 ml-10">
            <div class="border-b border-gray-900/10 pb-12">
              <h2 class="text-base font-semibold leading-7 text-gray-900">Listagem Faturamentos</h2>
                    ...
                    <div class="table w-full mt-5">
                      <div class="table-header-group">
                        ...
                        <div class="table-row">
                          ...
                          <div class="table-cell text-left ...">Cliente <span><FontAwesomeIcon icon={faSort}/></span></div>
                          <div class="table-cell text-left ...">CNPJ/CPF <span><FontAwesomeIcon icon={faSort}/></span></div>
                          <div class="table-cell text-left ...">BC IMCS <span><FontAwesomeIcon icon={faSort}/></span></div>
                          <div class="table-cell text-left ...">ICMS <span><FontAwesomeIcon icon={faSort}/></span></div>
                          <div class="table-cell text-left ...">Total <span><FontAwesomeIcon icon={faSort}/></span></div>
                          <div class="table-cell text-left ...">Vendedor <span><FontAwesomeIcon icon={faSort}/></span></div>
                          <div class="table-cell text-left ...">Chave Acesso <span><FontAwesomeIcon icon={faSort}/></span></div>
                          <div class="table-cell text-left ...">Status NFe <span><FontAwesomeIcon icon={faSort}/></span></div>
                          <div class="table-cell text-left ...">Data/Hora Autorização <span><FontAwesomeIcon icon={faSort}/></span></div>
