        ...
        <form>
          <div class="space-y-12 mt-10 ml-10">
            <div class="border-b border-gray-900/10 pb-12">
              <h2 class="text-base font-semibold leading-7 text-gray-900">Processamento Cupons Fiscais</h2>
                  ...
                  {/* Tabela */}
                    <div class="table w-full mt-5">
                      <div class="table-header-group">
                        {/* Colunas */}
                        <div class="table-row">
                          <div class="table-cell text-left ...">ECF <span><FontAwesomeIcon icon={faSort}/></span></div>
                          <div class="table-cell text-left ...">Número CCF <span><FontAwesomeIcon icon={faSort}/></span></div>
                          ...
                          <div class="table-cell text-left ...">Estoque Processado <span><FontAwesomeIcon icon={faSort}/></span></div>
                        </div>
                      </div>
                    </div>
                </div>
