                      ...
                      <div className="flex-auto w-full">
                        ...
                        <div className="flex rounded-md sm:max-w-md">
                          <Menu as="div" className="flex rounded-md">
                            ...
                            >
                              <div className="py-1">
                                {['Todos', 'Cliente', 'Usuário', 'Vendedor','Situação','Incompleto'].map(item => (
                                  <MenuItem key={item}>
                                    <a
                        ...
                        <tbody className="bg-white divide-y divide-gray-200 text-center">
                          {exampleData.map((data, index) => (
                            <tr key={index}>
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{data.entrega}</td>
